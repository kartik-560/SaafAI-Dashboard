...
//             {genderData.map(
//               ({ key, label, color, bgColor, borderColor, textColor }) => {
...
//                   <div
//                     key={gender}
//                     className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${genderColors[gender] || "text-gray-600 bg-gray-100"}`}
//                   >
...
//                     Minimum{" "}
//                     <span className="font-bold">{location.no_of_photos}</span>{" "}
...
//                       </div>
//                       <div className="text-2xl font-bold text-gray-900">
//                         {parseFloat(cleanerReviewStats.average_score).toFixed(
//                           1,
//                         )}
//                         /10
//                       </div>
